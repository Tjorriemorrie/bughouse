...
// validate config / set default options
            function expandConfig() {
                ...
                //console.info('cfg sparepieces', typeof cfg.sparePieces);
                //console.info('cfg sparepieces', cfg.sparePieces);
                if (!Array.isArray(cfg.sparePieces)) {
...
//------------------------------------------------------------------------------
            ...
            function buildSparePieces(color) {
                console.info('[buildSparePieces]', color, cfg.sparePieces);
                ...
                var html = '';
                for (var i = 0; i < pieces.length; i++) {
                    var hidden = (cfg.sparePieces.indexOf(pieces[i]) === -1) ? true : false;
                    html += buildPiece(pieces[i], hidden, SPARE_PIECE_ELS_IDS[pieces[i]]);
                }
...
// execute an array of animations
            function doAnimations(a, oldPos, newPos) {
                ...
                for (var i = 0; i < a.length; i++) {
                    ...
                    if (a[i].type === 'add' && !Array.isArray(cfg.sparePieces)) {
            ...
            widget.resize = function () {
                ...
                if (Array.isArray(cfg.sparePieces)) {
                    containerEl.find('.' + CSS.sparePieces)
                        ...
                        .css('minHeight', (SQUARE_SIZE + BOARD_BORDER_SIZE) + 'px');
                }
...
// set the starting position
            ...
            widget.setSparePieces = function (pieces) {
                if (!Array.isArray(pieces)) {
                    cfg.sparePieces = false;
                } else {
                    cfg.sparePieces = pieces;
                }
                drawBoard();
                console.info('cfg:setSparePieces', cfg.sparePieces);
            };
...
// reference: http://www.quirksmode.org/js/detect.html
            ...
            function mousedownSparePiece(e) {
                ...
                if (!Array.isArray(cfg.sparePieces)) return;
